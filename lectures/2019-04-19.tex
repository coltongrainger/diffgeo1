...
\begin{ex}[Helicoids]
    ...
    % recall that the differential is a derivation on 1 forms:  %
    \end{align*}
\end{ex}
...
\begin{rem}[Making ends meet]
    What are \term{exterior differential systems}? Translate the partial differential equations in terms of covector fields on smooth manifolds. The solutions to the differential equations correspond to the ideals on the manifold for which the pullback map is trivial (the kernel).
\end{rem}
...
\begin{defn}[Exact covector fields]
...
\begin{defn}[Closed covector fields]
